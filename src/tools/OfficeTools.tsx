...
export function BarcodeGenerator(){
  ...
  return <div className="stack"><label>Barcode value<input value={value} onChange={e=>setValue(e.target.value)} /></label><button className="primary" disabled={!value} onClick={generate}>Generate barcode</button><div className="canvas-wrap"><canvas ref={canvasRef}/></div><button className="secondary" disabled={!msg.includes('generated')} onClick={download}>Download PNG</button><Status>{msg}</Status></div>
}
